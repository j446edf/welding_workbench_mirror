...
class Ui_moduleHeatSource(object):
    ...
    def retranslateUi(self, moduleHeatSource):
        ...
        self.z_direction_1.setText(_translate("moduleHeatSource", "Welding direction - z axis"))
        self.z_direction_2.setText(_translate("moduleHeatSource", "Welding direction - z axis"))
